...
SECRET_KEY = 'django-insecure-8vpztkq@w2x#45-bb%n&&2*o-e+ox*i=p3e68m2=2^dt#vd-nv'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'rest_framework.authentication.BasicAuthentication',  # Optional: to support basic auth if needed
    ),
